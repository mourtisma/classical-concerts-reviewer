...
use crate::{dto::list_options_dto::{ListOptionsDto, OrderType}, model::sea_orm_search_params::SeaOrmSearchParams};
...
pub trait SeaOrmTransformer<'a, GetDto, CreateDto, UpdateDto, EntityOrderDto, E: sea_orm::EntityTrait, AM: sea_orm::ActiveModelTrait> where EntityOrderDto: Validate {
    ...
    fn list_options_to_search_params(list_options: ListOptionsDto<EntityOrderDto>) -> SeaOrmSearchParams<E::Column>;
    fn col_names_to_cols() ->  HashMap<String, E::Column>;
    fn build_order_vec(list_options_order: Option<Vec<EntityOrderDto>>) -> Option<Vec<(E::Column, Order)>>;
}
